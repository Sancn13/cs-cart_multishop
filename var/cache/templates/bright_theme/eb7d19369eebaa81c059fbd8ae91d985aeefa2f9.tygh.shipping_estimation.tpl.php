<?php /* Smarty version Smarty-3.1.21, created on 2021-06-13 17:02:51
         compiled from "C:\xampp\htdocs\cscmultiShop\design\themes\responsive\templates\addons\direct_payments\views\separate_checkout\components\shipping_estimation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:122264139360c6100b72bbe7-09974641%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb7d19369eebaa81c059fbd8ae91d985aeefa2f9' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\themes\\responsive\\templates\\addons\\direct_payments\\views\\separate_checkout\\components\\shipping_estimation.tpl',
      1 => 1622942573,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '122264139360c6100b72bbe7-09974641',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c6100b935b04_48911187',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c6100b935b04_48911187')) {function content_60c6100b935b04_48911187($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\block.hook.php';
...
">
            ...
            <?php $_smarty_tpl->tpl_vars['states'] = new Smarty_variable(fn_get_all_states(), null, 0);?>
...
,shipping_estimation_buttons<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'UTF-8');?>
...
">
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("get_rates"),'but_name'=>"dispatch[checkout.shipping_estimation.get_rates]",'but_role'=>"text",'but_id'=>"but_get_rates".((string)$_smarty_tpl->tpl_vars['id_suffix']->value)), 0);?>
...
--></div>
                    ...
                    <div class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['buttons_class']->value, ENT_QUOTES, 'UTF-8');?>
">
                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("select"),'but_role'=>"text",'but_name'=>"dispatch[checkout.update_shipping]",'but_id'=>"but_select_shipping".((string)$_smarty_tpl->tpl_vars['id_suffix']->value),'but_meta'=>"cm-dialog-closer"), 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['location']->value=="popup") {?>
<div class="ty-estimation-buttons buttons-container" id="shipping_estimation_buttons<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'UTF-8');?>
">
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="shipping_estimation"||$_REQUEST['show_shippings']=="Y") {?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("recalculate_rates"),'but_external_click_id'=>"but_get_rates".((string)$_smarty_tpl->tpl_vars['id_suffix']->value),'but_role'=>"text",'but_meta'=>"ty-btn__secondary cm-external-click ty-float-right ty-estimation-buttons__rate"), 0);?>


        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("select_shipping_method"),'but_external_click_id'=>"but_select_shipping".((string)$_smarty_tpl->tpl_vars['id_suffix']->value),'but_meta'=>"ty-btn__secondary cm-external-click cm-dialog-closer"), 0);?>

    <?php } else { ?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("get_rates"),'but_external_click_id'=>"but_get_rates".((string)$_smarty_tpl->tpl_vars['id_suffix']->value),'but_meta'=>"ty-btn__secondary cm-external-click"), 0);?>
...
if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="addons/direct_payments/views/separate_checkout/components/shipping_estimation.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/direct_payments/views/separate_checkout/components/shipping_estimation.tpl"),$_smarty_tpl);?>
