<?php /* Smarty version Smarty-3.1.21, created on 2021-06-13 17:02:53
         compiled from "C:\xampp\htdocs\cscmultiShop\design\themes\responsive\templates\addons\direct_payments\views\separate_checkout\components\promotion_coupon.tpl" */ ?>
<?php /*%%SmartyHeaderCode:180569106660c6100d0bb029-34153200%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9bc9c8a19006b1c158f91ae68d865bcf4b4b4801' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\themes\\responsive\\templates\\addons\\direct_payments\\views\\separate_checkout\\components\\promotion_coupon.tpl',
      1 => 1622942573,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '180569106660c6100d0bb029-34153200',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c6100d216b13_49576912',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c6100d216b13_49576912')) {function content_60c6100d216b13_49576912($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\block.hook.php';
...
" method="post">
        <input type="hidden" name="result_ids" value="checkout*,cart_status*,cart_items<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix_key']->value, ENT_QUOTES, 'UTF-8');?>
,payment-methods<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix_key']->value, ENT_QUOTES, 'UTF-8');?>
" />
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix_key']->value, ENT_QUOTES, 'UTF-8');?>
...
"
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_href'=>"checkout.delete_coupon?vendor_id=".((string)$_smarty_tpl->tpl_vars['vendor_id']->value)."&coupon_code=".((string)$_smarty_tpl->tpl_vars['coupon_code']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['_redirect_url']->value),'but_role'=>"delete",'but_meta'=>"ty-coupons__item-delete cm-ajax cm-ajax-full-render",'but_target_id'=>"checkout*,cart_status*,cart_items".((string)$_smarty_tpl->tpl_vars['suffix_key']->value)), 0);?>

            </li>
            <?php } ?>
            <?php if ($_smarty_tpl->tpl_vars['cart']->value['applied_promotions']) {?>
                <li class="ty-coupons__item">
                    <?php echo $_smarty_tpl->getSubTemplate ("addons/direct_payments/views/separate_checkout/components/applied_promotions.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="addons/direct_payments/views/separate_checkout/components/promotion_coupon.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/direct_payments/views/separate_checkout/components/promotion_coupon.tpl"),$_smarty_tpl);?>
