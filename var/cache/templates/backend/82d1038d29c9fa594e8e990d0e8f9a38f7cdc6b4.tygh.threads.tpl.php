<?php /* Smarty version Smarty-3.1.21, created on 2021-06-06 04:19:02
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\addons\vendor_communication\views\vendor_communication\threads.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78944587360bc2286c92968-71810205%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '82d1038d29c9fa594e8e990d0e8f9a38f7cdc6b4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\addons\\vendor_communication\\views\\vendor_communication\\threads.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '78944587360bc2286c92968-71810205',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bc2286d9c372_69870123',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bc2286d9c372_69870123')) {function content_60bc2286d9c372_69870123($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\modifier.enum.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('id','customer','subject','vendor','message','date','id','vendor_communication.ticket','customer','subject','vendor','message','vendor_communication.you','administration','vendor','customer','delete','date','no_data','vendor_communication.message_center'));
?>
...
>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['search']->value['communication_type']==smarty_modifier_enum("Addons\\VendorCommunication\\CommunicationTypes::VENDOR_TO_ADMIN")) {?>
                                <th width="15%"><?php echo $_smarty_tpl->__("subject");?>
</th>
                            <?php }?>
...
">
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['thread']->value['lastname'], ENT_QUOTES, 'UTF-8');?>
                            ...
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['search']->value['communication_type']==smarty_modifier_enum("Addons\\VendorCommunication\\CommunicationTypes::VENDOR_TO_ADMIN")) {?>
                                <td class="<?php if ($_smarty_tpl->tpl_vars['has_new_message']->value) {?>status-new__text<?php }?>" data-th="<?php echo $_smarty_tpl->__("subject");?>
">
                                    <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['thread_href']->value, ENT_QUOTES, 'UTF-8');?>
" class="no-link">
