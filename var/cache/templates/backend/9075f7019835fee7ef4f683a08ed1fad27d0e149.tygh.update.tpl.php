<?php /* Smarty version Smarty-3.1.21, created on 2021-07-06 05:29:13
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\views\profile_fields\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:140036277460e3bff93b5381-75215130%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9075f7019835fee7ef4f683a08ed1fad27d0e149' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\views\\profile_fields\\update.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '140036277460e3bff93b5381-75215130',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60e3bff95bcd59_35345117',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60e3bff95bcd59_35345117')) {function content_60e3bff95bcd59_35345117($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\function.script.php';
...
:</label>
                <div class="controls">
                    <input type="hidden" name="field_data[storefront_show]" value="<?php if ($_smarty_tpl->tpl_vars['field']->value['field_name']==="company") {
...
" <?php if ($_smarty_tpl->tpl_vars['field']->value['storefront_show']===smarty_modifier_enum("YesNo::YES")||!$_smarty_tpl->tpl_vars['id']->value) {?>checked="checked"<?php }?> <?php if ($_smarty_tpl->tpl_vars['field']->value['field_name']==="company") {?>disabled="disabled"<?php }?>/>
                </div>
            </div>
        <?php }?>
