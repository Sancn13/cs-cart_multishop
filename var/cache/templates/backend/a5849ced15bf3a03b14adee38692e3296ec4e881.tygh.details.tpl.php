<?php /* Smarty version Smarty-3.1.21, created on 2021-06-05 05:44:39
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\views\shipments\details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:113338143960bae517dbac38-25084180%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a5849ced15bf3a03b14adee38692e3296ec4e881' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\views\\shipments\\details.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '113338143960bae517dbac38-25084180',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bae517ec7e86_29990380',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bae517ec7e86_29990380')) {function content_60bae517ec7e86_29990380($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('product','quantity','product','sku','quantity','comments','shipment_date','shipment_info','shipment','on','by','status','order','print_packing_slip','print_pdf_packing_slip','delete','shipment_details'));
?>
...
<form name="update_shipment_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'UTF-8');?>
" method="post">
<input type="hidden" name="shipment_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipment']->value['shipment_id'], ENT_QUOTES, 'UTF-8');?>
" />
...
<br />
    ...
    <div class="order-notes statistic">
        <div class="row-fluid">
            ...
            <textarea class="input-xxlarge" cols="40" rows="5" name="shipment_data[comments]"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipment']->value['comments'], ENT_QUOTES, 'UTF-8');?>
</textarea>
        </div>
        <div class="row-fluid">
