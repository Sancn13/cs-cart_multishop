<?php /* Smarty version Smarty-3.1.21, created on 2021-06-06 04:18:55
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\addons\vendor_plans\views\vendor_plans\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139948975360bc227ff1df21-54500360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c330d5259fd371600a451de2519e57b8639304a3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\addons\\vendor_plans\\views\\vendor_plans\\manage.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '139948975360bc227ff1df21-54500360',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bc22800ca599_50604142',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bc22800ca599_50604142')) {function content_60bc22800ca599_50604142($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\function.script.php';
...
">
 ...
 (<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currencies']->value[(defined('CART_PRIMARY_CURRENCY') ? constant('CART_PRIMARY_CURRENCY') : null)]['symbol'], ENT_QUOTES, 'UTF-8');?>
)">
            <input type="text" name="plans_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['plan']->value['plan_id'], ENT_QUOTES, 'UTF-8');?>
...
">
            ...
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"vendor_plans:list_extra_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"vendor_plans:list_extra_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['has_management_permissions']->value) {?>
                    <li><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"plan_".((string)$_smarty_tpl->tpl_vars['plan']->value['plan_id']),'text'=>$_smarty_tpl->tpl_vars['plan']->value['plan'],'link_text'=>$_smarty_tpl->__("edit"),'act'=>"link",'href'=>"vendor_plans.update?plan_id=".((string)$_smarty_tpl->tpl_vars['plan']->value['plan_id'])), 0);?>
</li>
