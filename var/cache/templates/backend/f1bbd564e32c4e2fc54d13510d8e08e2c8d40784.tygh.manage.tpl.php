<?php /* Smarty version Smarty-3.1.21, created on 2021-06-05 06:09:13
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\addons\call_requests\views\call_requests\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:166454105760baead9755a03-37023662%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f1bbd564e32c4e2fc54d13510d8e08e2c8d40784' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\addons\\call_requests\\views\\call_requests\\manage.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '166454105760baead9755a03-37023662',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60baead98d8f97_33730481',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60baead98d8f97_33730481')) {function content_60baead98d8f97_33730481($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\modifier.date_format.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('id','date','call_requests.person_name_and_phone','order','status','call_requests.responsible','status','id','date','call_requests.person_name_and_phone','call_requests.no_name_specified','order','call_requests.responsible','delete','status','call_requests.requested_product','products_in_cart','call_requests.notes','call_requests.convenient_time','product','quantity','price','no_data','call_requests'));
?>
...
"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['request']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'UTF-8');?>
                ...
                <td data-th="<?php echo $_smarty_tpl->__("call_requests.person_name_and_phone");?>
">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['phone'], ENT_QUOTES, 'UTF-8');?>
                ...
                <td data-th="<?php echo $_smarty_tpl->__("order");?>
" class="nowrap">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_statuses']->value[$_smarty_tpl->tpl_vars['request']->value['order_status']]['description'], ENT_QUOTES, 'UTF-8');?>
                ...
                <td data-th="<?php echo $_smarty_tpl->__("call_requests.responsible");?>
">
...
">
                            ...
                            <i class="icon-caret-down cm-combination" id="on_call_req_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'UTF-8');?>
"></i>
                            <i class="icon-caret-up cm-combination hidden" id="off_call_req_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['request']->value['request_id'], ENT_QUOTES, 'UTF-8');?>
"></i>
                        </div>
                    <?php }?>
                </td>
