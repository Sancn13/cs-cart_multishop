<?php /* Smarty version Smarty-3.1.21, created on 2021-07-03 17:21:25
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\views\profile_fields\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22508352860e072658a3741-95727832%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '73f3764658439272001fa9d12efe919e1b8ce693' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\views\\profile_fields\\manage.tpl',
      1 => 1618395366,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '22508352860e072658a3741-95727832',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60e072661b8511_63545264',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60e072661b8511_63545264')) {function content_60e072661b8511_63545264($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_sizeof')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\modifier.sizeof.php';
...
%">
                                    <input type="hidden" name="fields_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
][storefront_show]" value="<?php if ($_smarty_tpl->tpl_vars['field']->value['field_name']==="company") {
echo htmlspecialchars(smarty_modifier_enum("YesNo::YES"), ENT_QUOTES, 'UTF-8');
} else {
echo htmlspecialchars(smarty_modifier_enum("YesNo::NO"), ENT_QUOTES, 'UTF-8');
}?>"/>
...
" <?php if ($_smarty_tpl->tpl_vars['field']->value['storefront_show']===smarty_modifier_enum("YesNo::YES")) {?>checked="checked"<?php }?> <?php if ($_smarty_tpl->tpl_vars['field']->value['field_name']==="company") {?>disabled="disabled"<?php }?>/>
                                </td>
                            <?php }?>
