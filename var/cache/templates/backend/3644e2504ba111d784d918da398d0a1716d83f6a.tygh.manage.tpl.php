<?php /* Smarty version Smarty-3.1.21, created on 2021-06-05 05:31:54
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\views\shipments\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8686915560bae21a18fde4-35697237%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3644e2504ba111d784d918da398d0a1716d83f6a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\views\\shipments\\manage.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8686915560bae21a18fde4-35697237',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bae21ab81471_17029312',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bae21ab81471_17029312')) {function content_60bae21ab81471_17029312($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('shipment_id','order_id','shipment_date','order_date','customer','status','shipment_id','order_id','shipment_date','order_date','customer','tools','view','print_slip','print_pdf_packing_slip','delete','status','no_data','shipments','order'));
?>
...
<div id="shipments_content">
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"shipments:bulk_edit")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"shipments:bulk_edit"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

        <?php echo $_smarty_tpl->getSubTemplate ("views/shipments/components/bulk_edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"shipments:bulk_edit"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
