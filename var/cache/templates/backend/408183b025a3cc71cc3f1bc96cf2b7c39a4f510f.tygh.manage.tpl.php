<?php /* Smarty version Smarty-3.1.21, created on 2021-05-27 10:47:04
         compiled from "C:\xampp\htdocs\cscmultiShop\design\backend\templates\views\companies\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:121868697360af4e78556309-88404788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '408183b025a3cc71cc3f1bc96cf2b7c39a4f510f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscmultiShop\\design\\backend\\templates\\views\\companies\\manage.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '121868697360af4e78556309-88404788',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60af4e792446f0_16794787',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60af4e792446f0_16794787')) {function content_60af4e792446f0_16794787($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\modifier.enum.php';
if (!is_callable('smarty_modifier_puny_decode')) include 'C:/xampp/htdocs/cscmultiShop/app/functions/smarty_plugins\\modifier.puny_decode.php';
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:bulk_edit")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:bulk_edit"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/bulk_edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<div class="table-responsive-wrapper <?php if (fn_allowed_for("MULTIVENDOR")) {?>longtap-selection<?php }?>">
    <table width="100%" class="table table-middle table--relative table-responsive">
    <thead <?php if (fn_allowed_for("MULTIVENDOR")) {?>data-ca-bulkedit-default-object="true"<?php }?>>
    <tr>
...
?>
 ...
 <?php if (fn_allowed_for("MULTIVENDOR")) {?>cm-longtap-target<?php }?>"
        <?php if (fn_allowed_for("MULTIVENDOR")) {?>
...
"
                   class="
                       cm-item cm-item-status-<?php echo htmlspecialchars(mb_strtolower($_smarty_tpl->tpl_vars['company']->value['status'], 'UTF-8'), ENT_QUOTES, 'UTF-8');?>

                       <?php if (fn_allowed_for("MULTIVENDOR")) {?>hide<?php }?>
                   "
            />
        </td>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_items", null, null); ob_start(); ?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:manage_tools_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:manage_tools_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']&&fn_allowed_for("ULTIMATE")&&fn_check_view_permissions("companies.update","POST")) {?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:manage_adv_buttons")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:manage_adv_buttons"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['is_companies_limit_reached']->value) {?>
            <?php $_smarty_tpl->tpl_vars['promo_popup_title'] = new Smarty_variable($_smarty_tpl->__("ultimate_or_storefront_license_required",array("[product]"=>(defined('PRODUCT_NAME') ? constant('PRODUCT_NAME') : null))), null, 0);?>
