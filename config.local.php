...
$config['http_host'] = '192.168.56.1';
$config['http_path'] = '/cscmultiShop';

// Host and directory where software is installed on secure server
$config['https_host'] = '192.168.56.1';
$config['https_path'] = '/cscmultiShop';
